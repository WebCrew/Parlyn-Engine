...
const required = [
  ...
  'docs/MAINTAINER-ACCEPTANCE-v0.5.0-beta.10.md',
  ...
  'docs/MAINTAINER-ACCEPTANCE-v0.5.0-beta.16.md',
  'build/icon.ico',
...
if (pkg.version !== '0.5.0-beta.16') throw new Error(`Unexpected package version: ${pkg.version}`);
