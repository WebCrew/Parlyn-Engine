...
- transform snapping and local/world gizmo modes — persistent snapping toggle
  and configurable Move, Rotate and Scale increments complete; Local/World modes remain;
